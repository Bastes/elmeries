...
update message model =
    case message of
        RollAll ->
            let
                ( top, topCmds ) =
                    Die.update Die.Roll model.top

                ( bottom, bottomCmds ) =
                    Die.update Die.Roll model.bottom
            in
...
view model =
    div []
        [ Html.map Top (Die.view model.top)
        , Html.map Bottom (Die.view model.bottom)
